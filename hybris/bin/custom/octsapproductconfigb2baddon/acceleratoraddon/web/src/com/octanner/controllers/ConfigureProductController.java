...
import com.octanner.UiGroupStatus;
import com.octanner.UiStatus;
import com.octanner.breadcrumb.ProductConfigureBreadcrumbBuilder;
import com.octanner.constants.Octsapproductconfigb2baddonConstants;
import com.octanner.util.impl.UiStatusSync;
...
public class ConfigureProductController extends AbstractProductConfigController
{
			...
			final HttpServletRequest request) throws CMSItemNotFoundException, UnsupportedEncodingException
	{
		...
		final String viewName = "addon:/" + Octsapproductconfigb2baddonConstants.EXTENSIONNAME
	...
	public ModelAndView updateConfigureProduct(
			@ModelAttribute(Octsapproductconfigb2baddonConstants.CONFIG_ATTRIBUTE) @Valid @MatchesPattern(Octsapproductconfigb2baddonConstants.CONFIG_ATTRIBUTE) final ConfigurationData configData,
			...
			UnsupportedEncodingException
	{
		...
		if (validationErrors)
		{
			...
			model.addAttribute(BindingResult.MODEL_KEY_PREFIX + Octsapproductconfigb2baddonConstants.CONFIG_ATTRIBUTE, bindingResult);
		}
		...
		model.addAttribute(Octsapproductconfigb2baddonConstants.CONFIG_ATTRIBUTE, latestConfiguration);
		...
		final ModelAndView modelAndView = new ModelAndView("addon:/" + Octsapproductconfigb2baddonConstants.EXTENSIONNAME
			...
			UnsupportedEncodingException
	{
		...
		if (validationErrors)
		{
			...
			redirectAttributes.addFlashAttribute(
					BindingResult.MODEL_KEY_PREFIX + Octsapproductconfigb2baddonConstants.CONFIG_ATTRIBUTE, bindingResult);
		}
		...
		uiStatusSync.updateUiStatus(configData, uiStatus);
		redirectAttributes.addFlashAttribute(Octsapproductconfigb2baddonConstants.CONFIG_ATTRIBUTE, latestConfiguration);
		redirectAttributes.addFlashAttribute(BindingResult.MODEL_KEY_PREFIX + Octsapproductconfigb2baddonConstants.CONFIG_ATTRIBUTE,
				bindingResult);
