package com.octanner.util.impl;
...
import com.octanner.validator.ConflictError;
import com.octanner.validator.MandatoryFieldError;
import com.octanner.validator.ValidatorTestData;
...
public class ErrorResolverTest {
	...
	public void setup() {
		...
		ObjectError validationError = new FieldError(
				Octsapproductconfigb2baddonConstants.CONFIG_ATTRIBUTE, getPath(
