...
import com.octanner.validator.ConflictChecker;
...
public class ConfigureProductControllerTest extends AbstractProductConfigControllerTest
{
	...
	public void testUpdateConfigureProductRedirectIsCorrect() throws Exception
	{
		...
		assertEquals("addon:/octsapproductconfigb2baddon/pages/configuration/configurationPage", forward);
	}
	...
	public void testHandleValidationErrorsBeforeUpdate_noErr()
	{
		final BindingResult bindingResult = new BeanPropertyBindingResult(configData,
				Octsapproductconfigb2baddonConstants.CONFIG_ATTRIBUTE);
	...
	{
		final FieldError error = new FieldError(Octsapproductconfigb2baddonConstants.CONFIG_ATTRIBUTE, "groups[0].cstics[3]", "aaa",
				false, new String[]
	...
	{
		final FieldError error = new FieldError(Octsapproductconfigb2baddonConstants.CONFIG_ATTRIBUTE,
