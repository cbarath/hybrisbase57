...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/octmomentsstorefront/electronics/en",
						"https://electronics.local:9002/octmomentsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/octmomentsstorefront/electronics/en",
						"https://electronics.local:9002/octmomentsstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/octmomentsstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/octmomentsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/octmomentsstorefront/electronics/en",
						"https://electronics.local:9002/octmomentsstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/octmomentsstorefront",
						"https://electronics.local:9002/octmomentsstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/octmomentsstorefront",
						"https://electronics.local:9002/octmomentsstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/octmomentsstorefront/electronics/en",
						"https://electronics.local:9002/octmomentsstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
