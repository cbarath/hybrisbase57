...
<%@ taglib prefix="config"
	tagdir="/WEB-INF/tags/addons/octsapproductconfigb2baddon/desktop/configuration"%>
<%@ taglib prefix="cssConf" uri="/WEB-INF/tags/addons/octsapproductconfigb2baddon/desktop/configuration/sapproductconfig.tld"%>
...
<c:if test="${multiGroups}">
	...
	<jsp:useBean id="cons"
		class="com.octanner.util.impl.ConstantHandler"
		scope="session" />
