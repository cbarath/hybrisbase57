...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/octperformancestorefront/electronics/en",
						"https://electronics.local:9002/octperformancestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/octperformancestorefront/electronics/en",
						"https://electronics.local:9002/octperformancestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/octperformancestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/octperformancestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/octperformancestorefront/electronics/en",
						"https://electronics.local:9002/octperformancestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/octperformancestorefront",
						"https://electronics.local:9002/octperformancestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/octperformancestorefront",
						"https://electronics.local:9002/octperformancestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/octperformancestorefront/electronics/en",
						"https://electronics.local:9002/octperformancestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
