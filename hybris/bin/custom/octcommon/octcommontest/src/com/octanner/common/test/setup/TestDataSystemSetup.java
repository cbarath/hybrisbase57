 ...
 *
 */
package com.octanner.common.test.setup;
...
import com.octanner.common.test.constants.OctcommonTestConstants;
import com.octanner.common.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = OctcommonTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/octcommontest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/octcommontest/import/reviews.impex");
			...
			importImpexFile(context, "/octcommontest/import/cstickets.impex");
		}
	}
}
