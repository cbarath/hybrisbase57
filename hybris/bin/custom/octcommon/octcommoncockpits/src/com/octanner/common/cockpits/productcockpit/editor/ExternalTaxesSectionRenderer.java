 ...
 *
 */
package com.octanner.common.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("octcommoncockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("octcommoncockpits.product.externalTaxes"));
