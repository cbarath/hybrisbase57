 ...
 *
 */
package com.octanner.common.cockpits.setup;
...
import com.octanner.common.cockpits.constants.OctcommonCockpitsConstants;
 ...
 */
@SystemSetup(extension = OctcommonCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(OctcommonCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(OctcommonCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						OctcommonCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/octcommoncockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
