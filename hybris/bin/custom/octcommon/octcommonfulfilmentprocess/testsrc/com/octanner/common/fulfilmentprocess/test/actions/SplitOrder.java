 ...
 *
 */
package com.octanner.common.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(OctcommonFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(OctcommonFulfilmentProcessConstants.PARENT_PROCESS);
