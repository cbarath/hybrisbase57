 ...
 *
 */
package com.octanner.common.core.hmc;
...
/**
 * Provides necessary meta information about the octcommoncore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class OctcommonCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(OctcommonCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.octanner.common.core.hmc.locales";
